...
\usepackage{tikz}
\usetikzlibrary{matrix,positioning,decorations.pathmorphing}
\usepackage{tikz-cd}
...
\colorlet{alertcolor}{fg}

% Colores predefinidos
\usebeamercolor{frame rule}
\colorlet{secondarycolor}{bg}
...
\input{temas/01-sistemas-matrices-determinantes/tema01}
